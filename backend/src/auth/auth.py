...
def get_token_auth_header():
    ...
    if not headers:
        raise AuthError("No header found", 401)
    header_parts = headers.split(" ")
    if header_parts[0].lower() != "bearer":
        raise AuthError("bearer is missing in header", 401)
...
@TODO implement verify_decode_jwt(token) method
    ...
    !!NOTE urlopen has a common certificate error
     described here: https://stackoverflow.com/questions/50236117/scraping-ssl-certificate-verify-failed-error-for-http-en-wikipedia-org
'''
